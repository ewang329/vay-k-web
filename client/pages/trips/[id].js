...
import Flight from '../../components/trips/Flight';
import Lodge from '../../components/trips/Lodge';
import Map from '../../components/trips/Map';
import Photo from '../../components/trips/Photo';
import Webpage from '../../components/trips/Webpage';
import StopContainer from '../../components/trips/StopContainer';
import BoxContainer from '../../components/trips/BoxContainer';
import CityContainer from '../../components/trips/CityContainer';
    ...
    return (
        <div className={styles.tripDetailContainer}>
            ...
            <div className={styles.rightPane}>
                <div className={styles.topMenuContainer} onClick={e => onMenuSelected(e)}>
                    <div data-menu='map'>
